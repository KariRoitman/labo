...
PARAM  <- list()
PARAM$experimento <- "09sinpanFE"

PARAM$exp_input  <- "09p_DR_60Var2"
...
PARAM$RandomForest$semilla  <- 563214    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 568947   # cambiar por la propia semilla
...
CanaritosAsesinos  <- function( canaritos_ratio=0.2, canaritos_desvios=3.0, canaritos_semilla=999983 )
{
  ...
  umbral  <- tb_importancia[ Feature %like% "canarito", 
                             median(pos)]  #Atencion corto en la mediana mas desvios!!
