...
PARAM  <- list()
PARAM$experimento  <- "09sinpan2ZZ"
PARAM$exp_input  <- "09sinpan2HT"
...
PARAM$semilla_primos  <- c(235689, 215487, 236589)  # se utiliza para generar el vector de  PARAM$semillerio  semillas
