...
PARAM  <- list()
PARAM$experimento  <- "07k_ZZ_60Var2"
PARAM$exp_input  <- "07k_HT_60Var2"

#Atencion, que cada modelos se procesa con 5 semillas, ajuste a SUS necesidades
PARAM$modelos_rank  <- c( 11 )  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
