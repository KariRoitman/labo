...
PARAM  <- list()
PARAM$experimento  <- "07sinpan2ZZ"
PARAM$exp_input  <- "07sinpan2HT"
...
PARAM$semilla_primos  <- C(235698, 256398, 145289, 238897)  # se utiliza para generar el vector de  PARAM$semillerio  semillas
