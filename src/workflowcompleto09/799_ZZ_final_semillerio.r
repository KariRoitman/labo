...
PARAM  <- list()
PARAM$experimento  <- "09c_ZZ_60Var2"
PARAM$exp_input  <- "09c_HT_60Var2"
...
PARAM$semillerio  <- 0   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
PARAM$semilla_primos  <- 435051  # se utiliza para generar el vector de  PARAM$semillerio  semillas
